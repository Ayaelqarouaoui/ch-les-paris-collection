...
export const products: Product[] = [
  ...
  { id: 'chale-fourrure-chinchilla', name: 'Châle Chinchilla', description: 'Douceur incomparable.', price: 45, image: Fourrure5, category: 'Châles en Fourrure' },
  { id: 'chale-fourrure-noir', name: 'Châle Fourrure Noir Absolu', description: 'Mystère et sophistication.', price: 50, image: Fourrure6, category: 'Châles en Fourrure' },
  { id: 'chale-fourrure-cape', name: 'Cape Fourrure Parisienne', description: 'Allure majestueuse.', price: 50, image: Fourrure7, category: 'Châles en Fourrure' },

  // --- Châles Paisley (L-qdam + J-dad) ---
  { id: 'chale-imperial-paisley', name: 'Châle Impérial Paisley', description: 'Douceur extrême et motifs ancestraux.', price: 90, image: Paisley1, category: 'Châles Paisley', featured: true },
  { id: 'chale-paisley-royal', name: 'Châle Paisley Royal', description: 'Héritage noble et raffiné.', price: 100, image: Paisley2, category: 'Châles Paisley', featured: true },
